...
class sASlideAction extends StatefulWidget {
  ...
  @override
  sASlideActionState createState() => sASlideActionState();
}

/// Use a GlobalKey to access the state. This is the only way to call [sASlideActionState.reset]
class sASlideActionState extends State<sASlideAction>
